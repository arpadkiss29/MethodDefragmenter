...
public class Saleh1Visitor extends GroupingVisitor implements FragmentVisitor {

	public Saleh1Visitor(String analyzedClass, IFile iFile, IJavaProject iJavaProject,
