...
public class FeatureEnvyGroupingVisitor implements FragmentVisitor{
	...
	public FeatureEnvyGroupingVisitor(String analyzedClass, IFile iFile, IJavaProject iJavaProject,
