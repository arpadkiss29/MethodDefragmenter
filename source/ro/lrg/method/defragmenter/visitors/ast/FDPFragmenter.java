...
//	private Stack<AbstractInternalCodeFragment> lastNode;	
...
//		AICF.computeDataAccesses(analyzedClass, considerStaticFieldAccess, libraryCheck, minBlockSize);
//		return AICF.getFDPMap();
//	}
//
...
//		fragmentToBeMerged.accept(visitor);
//		List<ASTNode> statements = visitor.getAllInternalStatements();
//		
//		if (fragmentToBeMerged.getChildrenSize() != 1 
//				|| fragmentToBeMerged.getChild(0) instanceof InternalCodeFragment
//				|| !canAddStatementsToFragment(parent, statements, false)) {
//			return false;
//		}
//		return true;
//	}
...
//				AllInternalStatementsVisitor visitor = new AllInternalStatementsVisitor();
//				leaf.accept(visitor);
//				List<ASTNode> leafStatements = visitor.getAllInternalStatements();
//
//				if (FDPMapOfAcumulatingLeaf.size() == 0 || FDPMapOfLeaf.size() > 0)  {
//					if (!canAddStatementsToFragment(acumulatingLeaf, leafStatements, true)) {
//						parent.addChild(acumulatingLeaf);
//						acumulatingLeaf = newInternalCodeFragmentLeaf();
//					}
//					// Adding it to the current leaf
//					acumulatingLeaf.addInternalStatements(leafStatements);
//					FDPMapOfAcumulatingLeaf = computeAndGetFDPMapOfFragment(acumulatingLeaf);
////				//-------------------------------------------------------------------------------------
...
//							
//							AllInternalStatementsVisitor visitor2 = new AllInternalStatementsVisitor();
//							nextLeaf.accept(visitor2);
//							List<ASTNode> nextLeafStatements = visitor2.getAllInternalStatements();
//							
...
//									parent.addChild(leaf);
//									i = j;
//									acumulatingLeaf.addInternalStatements(nextLeafStatements);
...
//									acumulatingLeaf = null;
//									
//									leaf.addInternalStatements(nextLeafStatements);
//									parent.addChild(leaf);
//									i = j;
//									break;
//								} else {
